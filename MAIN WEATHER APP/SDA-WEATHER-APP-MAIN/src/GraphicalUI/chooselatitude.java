...
public class chooselatitude extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jTextPane2.getText().length()==0||jTextPane1.getText().length()==0)
        {
            return;
        }
             String text1 = jTextPane2.getText(); 
             String text2 = jTextPane1.getText(); 
               ...
               try {
                     ...
                     cm = new CacheManager(value1,value2,bl.getDB());
