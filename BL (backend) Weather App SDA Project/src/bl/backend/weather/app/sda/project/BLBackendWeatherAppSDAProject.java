...
public class BLBackendWeatherAppSDAProject {
    ...
    public static void main(String[] args) {
        ...
        loc.setLatitude(31.5497);
        loc.setLongitude(74.3436);
        
        WeatherData wd = apiStonks.getCurrentWeather(loc.getLatitude(),loc.getLongitude());
        
        System.out.println("LATITUDE INPUT: "+ loc.getLatitude());
        System.out.println( "LONGITUDE INPUT:  " + loc.getLongitude());
        ...
        AirPollutionData apd = apiStonks.getAirPollutionData(loc.getLatitude(),loc.getLongitude());
        ...
        List<WeatherForecastData> forecastDataList = apiStonks.getWeatherForecast(loc.getLatitude(),loc.getLongitude());
